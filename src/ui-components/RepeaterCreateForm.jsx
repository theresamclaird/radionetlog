...
export default function RepeaterCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setInputFrequency(initialValues.inputFrequency);
    setInputTone(initialValues.inputTone);
    setOutputFrequency(initialValues.outputFrequency);
    setOutputTone(initialValues.outputTone);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Repeater(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "RepeaterCreateForm")}
      {...rest}
    >
      <TextField
        label="Call sign"
