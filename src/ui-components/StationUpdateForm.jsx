...
export default function StationUpdateForm(props) {
  const {
    id: idProp,
    station: stationModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = stationRecord
      ? { ...initialValues, ...stationRecord }
      : initialValues;
  ...
  const [stationRecord, setStationRecord] = React.useState(stationModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Station, idProp)
        : stationModelProp;
      setStationRecord(record);
    };
    queryData();
  }, [idProp, stationModelProp]);
  React.useEffect(resetStateValues, [stationRecord]);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Station.copyOf(stationRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "StationUpdateForm")}
      {...rest}
    >
      <TextField
        label="Call sign"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || stationModelProp)}
